            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Aprobacion de Alumnos</h4>
                            ...
                            <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                        	<td>25-1233-2019</td>
                                        	<td>Osmin Alexis Beltran</td>
                                        	<td>01</td>
                                        	<td>primer grado</td>
                                                 <td><a class="waves-effect waves-light btn">Aprobar</a></td>
                                                 <td><a class="waves-effect waves-light btn">Desaprobar</a></td>
                                        ...
                                        <td>25-1233-2019</td>
                                        	<td>Osmin Alexis Beltran</td>
                                        	<td>01</td>
                                        	<td>primer grado</td><td>
                                <a class="waves-effect waves-light btn">Aprobar</a>
        </td>
        <td><a class="waves-effect waves-light btn">Desaprobar</a></td>
                                        </tr>
                                        <tr>
